...
function App() {
  ...
  const handleInputChange = (e) => {
    ...
    // Clear selected preset if user manually changes game parameters
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Parse the winning numbers from comma or space-separated string
  ...
  const presetGames = {
    ...
    megamillions: { regularPickTotal: 5, regularPickMax: 70, pbPickTotal: 1, pbPickMax: 24 },
